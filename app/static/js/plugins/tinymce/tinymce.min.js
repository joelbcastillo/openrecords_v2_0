...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        var C, x, w, N, E, _, S, k, T, R, A, B, D, L, M, P, O, H, I, F = "sizzle" + -new Date, z = window.document, U = 0, W = 0, V = n(), $ = n(), q = n(), j = function (e, t) {
            return e === t && (A = !0), 0
        ...
        function t(n) {
            ...
            var M = this, P = n.doc, O = 0, H = 1, I = 2, F = !0, z = !1, U = "startOffset", W = "startContainer", V = "endContainer", $ = "endOffset", q = e.extend, j = n.nodeIndex;
            return q(M, {
                startContainer: P,
                startOffset: 0,
                endContainer: P,
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, C, x, w, N, E, _, S, k, T, R, A, B, D, L, M, P, O, H, I, F = 0, z = t.decode, U, W = n.makeMap("src,href,data,background,formaction,poster"), V = /((java|vb)script|mhtml):/i, $ = /^data:/i;
        ...
        return function (i, s) {
            ...
            var _ = s.dom, S = t.each, k, T, R, A, B, D, L, M, P, O, H, I, F, z, U, W, V = s.getDoc(), $ = document, q = r.ie && r.ie < 11, j = Math.abs, Y = Math.round, X = s.getBody(), K, G;
        ...
        var e = function (e) {
            ...
            var t = e.getBody(), n = e.getDoc().documentElement, r = {
                left: t.scrollLeft,
                top: t.scrollTop
        ...
        function y(c) {
            ...
            function G() {
                ...
                var w = b(F, 1, oe, E), _ = b(F, -1, ae, N), R = b(K, 1, E, N), D = b(K, -1, N, E), L = b(z, -1, a.upUntil), M = b(z, 1, a.downUntil);
            ...
            var re = c.getBody(), ie = new t(re), oe = b(v, ie.next), ae = b(v, ie.prev), se = new o(c.getBody(), S), le = "sel-" + c.dom.uniqueId(), ce, ue = c.$;
        ...
        var D = e.DOM, L = r.ThemeManager, M = r.PluginManager, P = N.extend, O = N.each, H = N.explode, I = N.inArray, F = N.trim, z = N.resolve, U = g.Event, W = w.gecko, V = w.ie;
        return B.prototype = {
            render: function () {
                function e() {
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [], y, b, C, x, w, N, E, _, S, k, T, R, A, B, D, L, M, P, O, H, I, F, z = Math.max, U = Math.min;
